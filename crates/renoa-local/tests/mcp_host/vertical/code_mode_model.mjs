...
if (toolResults.length === 0) {
  ...
  if (search.total !== 1 || search.items[0].id !== "direct:fixture" || search.tool_matches.length !== 1 || search.tool_matches[0].name !== "echo" || "x-mcp-header" in search.tool_matches[0].input_schema.properties.tenant) process.exit(3);
  ...
  const result = toolResults[1].result;
