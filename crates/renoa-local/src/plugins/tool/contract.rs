    ...
    ToolSpec {
        ...
        input_schema: json!({
            ...
            "properties": {
                ...
                "restart": {
                    "type": "boolean",
                    "description": "For connect or authorize: explicitly abandon an expired or unusable prior OAuth flow and start again. Use connect with the retained package, server, connection and credential when installation succeeded but no connection was published. Use authorize for an existing registered connection."
                }
            },
            "required": ["action"],
