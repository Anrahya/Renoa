...
pub(super) const MIGRATE_V11_TO_V12: &str = "
    ...
    SELECT connection_id, operation_id, phase, callback_port, NULL, expires_at_ms
...
";
mod oauth_staging;
pub(super) use oauth_staging::MIGRATE_V12_TO_V13;
